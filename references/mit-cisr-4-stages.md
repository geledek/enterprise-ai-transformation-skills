...
**Stage 1:** Has literacy and acceptable-use policy, but no tracked, value-attributed pilot.
**Stage 2:** Running tracked pilots with named business cases and measured value — but value is contained to single functions; no shared platform.
**Stage 3:** Shared AI platform with reusable services; dashboards expose AI value; test-and-learn is the default operating mode.
**Stage 4:** AI in default decision-making across functions; monetizing AI capability externally; combining all four AI types (analytical, generative, agentic, robotic).
