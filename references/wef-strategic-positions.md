...
# WEF Strategic Positions for AI
...
1. Identify the AI-induced reconfiguration in your value chain: what was the historical scarcity? Has AI removed it? What is the new bottleneck?
2. Generate 2–4 candidate positions, each with a distinct core belief about where advantage now lives.
3. Force a primary-position decision in the executive team. Name it. Resource it disproportionately.
4. Set explicit stopping rules for activities that don't serve the primary.
5. Communicate the trade-off: "We are not pursuing X with equal emphasis."
