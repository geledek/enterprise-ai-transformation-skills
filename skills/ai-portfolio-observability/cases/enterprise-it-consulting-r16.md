...
## Applying ai-portfolio-observability
...
- Internal cross-reference: skills/ai-portfolio-observability/cases/european-fintech-case.md (CSAT-22% miss pattern referenced in Dimension 2)
- Internal cross-reference: skills/ai-idea-diagnostic/cases/klarna.md (precedent for net-of-oversight ROI pattern)
