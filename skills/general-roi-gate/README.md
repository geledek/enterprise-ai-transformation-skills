...
After a pilot has run and produced evidence, before committing to production investment or board approval. If you're still at concept stage, use `general-idea-diagnostic` first. If you're designing the pilot, use `process-pilot-design` first.
