...
- **Buy vs. build:** Is the organization buying foundation model capability or trying to train its own? (NANDA 2:1 buy advantage — consult `nanda-buy-vs-build.md`)
