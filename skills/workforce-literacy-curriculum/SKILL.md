---
name: workforce-literacy-curriculum
...
Anchor: BCG 88/25 — workers using AI weekly jumped from 55% to 72% YoY, but only when managers model the behavior. Training without manager role-modeling is theatre.
...
4. **Executive MUST-Agent:** sign one buy-vs-build decision with explicit governance rationale.
