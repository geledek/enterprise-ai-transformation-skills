...
The principle: **Buy the model. Build the orchestration.** Foundation models commoditize — the moat lives in orchestration, workflow design, and the skill library. (Consult `nanda-buy-vs-build.md` and `andrew-ng-three-moats.md`.)
...
- `nanda-buy-vs-build.md` — 2:1 buy advantage; orchestration as moat; vendor archetypes
